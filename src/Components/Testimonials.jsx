...
const Testimonials = () => {
  return (
    <motion.div
      ...
      <p className='text-gray-500 max-w-80 text-center mb-12 mx-auto'>Genuine voices. Lasting impressions. Discover what our clients say about finding home with Estate du Oud.</p>
